...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Nichole.Weber92',
      password: 'g3zPVQgFK2sc274',
      email: 'Theresa.Rippin38@yahoo.com',
      name: 'Donna Rau',
      userType: 477,
      mobileNo: '1-863-364-0081 x2680',
      resetPasswordLink: {},
      loginRetryLimit: 19,
      loginReactiveTime: '2022-08-15T19:00:57.917Z',
      id: '624160ebc02939142573c059'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Angie.Pouros82',
        'password':'TlIoUYeyJ5a1HZD',
        'email':'Layla.Langworth22@gmail.com',
        'name':'Blake Farrell III',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'330.956.2937 x0327',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Layla.Langworth22@gmail.com', });
